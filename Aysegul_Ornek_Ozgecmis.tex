...
%%%%
% EN
% EU AI Act Transparency Disclaimer
% 
% Parts of this LaTeX resume template was generated with the assistance of an
% artificial intelligence system.
%
% The file itself is NOT an AI system. It does not perform any
% automated decision-making, inference, or learning.
%
% This is a static template intended for human use, inspection,
% modification, and publication.
%
% Users are advised to verify the structure and content before using it
% in any professional or legal context.
%
% This disclaimer is provided in accordance with the transparency
% requirements of Regulation (EU) 2024/1689 (EU AI Act), Article 52.
%%%%
% TR
% AB Yapay Zekâ Tüzüğü (EU AI Act) Şeffaflık Uyarısı
%
% Bu LaTeX özgeçmiş şablonunun bazı kısımları, bir yapay zekâ sistemi yardımıyla
% oluşturulmuştur.
%
% Bu dosyanın kendisi bir yapay zekâ sistemi DEĞİLDİR. Herhangi bir
% otomatik karar verme, çıkarım yapma ya da öğrenme yeteneği yoktur.
%
% Bu, insanlar tarafından kullanılması, incelenmesi ve düzenlenmesi
% amacıyla oluşturulmuş statik bir şablondur.
%
% Profesyonel veya hukuki bir bağlamda kullanılmadan önce, içerik ve
% yapısının doğrulanması tavsiye edilir.
%
% Bu uyarı, 2024/1689 sayılı AB Yapay Zekâ Tüzüğü'nün 52. maddesi
% kapsamındaki şeffaflık yükümlülüğü gereği sağlanmaktadır.
%%%%
